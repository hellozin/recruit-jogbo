...
public class DuplicatedException extends ServiceRuntimeException {
    ...
    private static final String MESSAGE_KEY = "error.duplicated";

    private static final String MESSAGE_DETAILS = "error.duplicated.details";

    public DuplicatedException(Class cls, String... values) {
        this(cls.getSimpleName(), values);
    }

    public DuplicatedException(String targetName, String... values) {
